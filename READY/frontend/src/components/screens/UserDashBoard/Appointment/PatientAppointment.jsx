...
function PatientAppointment() {
  ...
  const getAvailableSlots = async () => {
    ...
    // console.log(formatDateForDateInput(date));
   ...
   //setAvailableSlots (newSlotList);
    ...
    try {
      console.log(localStorage.getItem("token"))
      console.log(formatDateForDateInput(date),doctorSelected)
      ...
      console.log("ali newdbabejnjivnikrnvge4ieng")
